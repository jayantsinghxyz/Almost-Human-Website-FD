          ...
          <form onSubmit={handleSubmit} className="space-y-5 md:space-y-6 mb-6 sm:mb-8" aria-label="Contact form">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button
                type="submit"
                size="lg"
                className="flex-1 bg-white text-foreground hover:bg-white/90 h-12 md:h-14 text-lg sm:text-lg font-bold !scale-100 !translate-y-0 !translate-x-0"
                disabled={isSubmitting}
              >
                {isSubmitting ? (
                  <>
              ...
              <Button
                ...
                className="flex-1 border-2 border-white text-white hover:bg-white hover:text-foreground h-12 md:h-14 text-lg sm:text-lg font-bold !scale-100 !translate-y-0 !translate-x-0"
                disabled={isSubmitting}
